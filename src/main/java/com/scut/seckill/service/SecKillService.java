...
public class SecKillService {
    ...
    public SecKillEnum handleByPessLockInMySQL(Map<String, Object> paramMap) {
        ...
        if (result > 0){
            ...
            if (insertFlag){
                System.out.println("用户:"+user.getUsername()+"秒杀商品："+product.getProductName()+"成功!");
            ...
            System.out.println("用户:"+user.getUsername()+"重复秒杀商品"+product.getProductName());
            throw new SecKillException(SecKillEnum.REPEAT);
        }
    }
    ...
    public SecKillEnum handleByPosiLockInMySQL(Map<String, Object> paramMap){
        ...
        if (lastStock >= 0){
            ...
            if (!secKillSuccess){
                System.out.println("用户:"+user.getUsername()+"秒杀商品"+product.getProductName()+"失败!");
    ...
    public SecKillEnum handleByAtomicInteger(Map<String, Object> paramMap) {
        ...
        if (stock < 0) {
            System.out.println("商品:"+product.getProductName()+"库存不足, 抢购失败!");
            throw new SecKillException(SecKillEnum.LOW_STOCKS);
        }
